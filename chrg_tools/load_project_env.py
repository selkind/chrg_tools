...
def load_project_env(working_dir: str = '') -> Dict:
    """Loads environment variables from .env file and api/db configuration values from config.toml
    in the specified directory (current working directory by default).
